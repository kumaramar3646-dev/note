...
class TodoHomePage extends StatefulWidget {
  ...
  @override
  State<TodoHomePage> createState() => _HomePageState();
}

class _HomePageState extends State<TodoHomePage> {

  List<String> mPriorities = ["High", "Medium", "Low"];
          ...
          return mData.isNotEmpty ? ListView.builder(
              ...
              itemBuilder: (_, index){
                return CheckboxListTile(
                  ...
                  value: mData[index].data()["isCompleted"],
